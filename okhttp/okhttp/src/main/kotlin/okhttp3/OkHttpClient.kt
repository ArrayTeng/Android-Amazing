...
open class OkHttpClient internal constructor(
  ...
  //存储一批的连接，当你需要创建连接的时候不是直接去新建一个连接，而是从连接池中查找是否是有有一个可用的线程，有的话直接复用
